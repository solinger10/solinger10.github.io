        ...
        <div>
            <form className="airport-form">
                ...
                <div className="form-group textola side-button">
                    <input id="startInput" type="text" name="s"  onClick={(e)=>{e.target.setSelectionRange(0, 1000)}} placeholder="123 wsilfta Street, New York, NY" className="form-control"></input>
